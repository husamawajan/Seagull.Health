...
namespace Seagull.Core.Configuration
{
    /// <summary>
    /// Represents a SeagullConfig
    /// </summary>
    public partial class SeagullConfig : IConfigurationSectionHandler
    {
        /// <summary>
        ...
        public object Create(object parent, object configContext, XmlNode section)
        {
            ...
            var supportPreviousSeagullcommerceVersionsNode = section.SelectSingleNode("SupportPreviousSeagullcommerceVersions");
            config.SupportPreviousSeagullcommerceVersions = GetBool(supportPreviousSeagullcommerceVersionsNode, "Enabled");
        ...
        /// <summary>
        /// Indicates whether we should support previous SeagullCommerce versions (it can slightly improve performance)
        /// </summary>
        public bool SupportPreviousSeagullcommerceVersions { get; private set; }
        ...
        /// <summary>
        /// A list of plugins ignored during SeagullCommerce installation
        /// </summary>
