...
namespace Seagull.Core.Domain
{
    public class StoreInformationSettings : ISettings
    {
        /// <summary>
        /// Gets or sets a value indicating whether "powered by SeagullCommerce" text should be displayed.
        /// Please find more info at http://www.Seagullcommerce.com/copyrightremoval.aspx
        /// </summary>
        public bool HidePoweredBySeagullCommerce { get; set; }
