...
using Seagull.Core.Html.CodeFormatter;
using Seagull.Core.Infrastructure;

namespace Seagull.Core.Html
{
    /// <summary>
    ...
    public partial class BBCodeHelper
    {
            ...
            bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote, bool replaceImg)
        {
            ...
            if (replaceUrl)
            {
                ...
                // format the url tags: [url=http://www.SeagullCommerce.com]my site[/url]
                // becomes: <a href="http://www.SeagullCommerce.com">my site</a>
                text = regexUrl1.Replace(text, string.Format("<a href=\"$1\" rel=\"nofollow\"{0}>$2</a>", newWindow ? " target=_blank" : ""));

                // format the url tags: [url]http://www.SeagullCommerce.com[/url]
                // becomes: <a href="http://www.SeagullCommerce.com">http://www.SeagullCommerce.com</a>
            ...
            if (replaceImg)
            {
                // format the img tags: [img]http://www.SeagullCommerce.com/Content/Images/Image.jpg[/img]
                // becomes: <img src="http://www.SeagullCommerce.com/Content/Images/Image.jpg">
