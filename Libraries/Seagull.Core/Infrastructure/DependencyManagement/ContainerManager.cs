...
namespace Seagull.Core.Infrastructure.DependencyManagement
{
    /// <summary>
    /// Container manager
    /// </summary>
            ...
            foreach (var constructor in constructors)
            {
                try
                {
                    ...
                    foreach (var parameter in parameters)
                    {
                        ...
                        if (service == null) throw new SeagullException("Unknown dependency");
                        parameterInstances.Add(service);
                    }
                    return Activator.CreateInstance(type, parameterInstances.ToArray());
                }
                catch (SeagullException)
                {

                }
            }
            throw new SeagullException("No constructor  was found that had all the dependencies satisfied.");
        }
