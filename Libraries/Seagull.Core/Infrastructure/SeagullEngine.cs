...
namespace Seagull.Core.Infrastructure
{
    ...
    /// Engine
    /// </summary>
    public class SeagullEngine : IEngine
    {
        #region Fields
        ...
        protected virtual void RegisterDependencies(SeagullConfig config)
        {
            var builder = new ContainerBuilder();
            
            //dependencies
            var typeFinder = new WebAppTypeFinder();
            builder.RegisterInstance(config).As<SeagullConfig>().SingleInstance();
        ...
        /// </summary>
        /// <param name="config">Config</param>
        protected virtual void RegisterMapperConfiguration(SeagullConfig config)
        {
            //dependencies
            var typeFinder = new WebAppTypeFinder();
        ...
        /// </summary>
        /// <param name="config">Config</param>
        public void Initialize(SeagullConfig config)
        {
            //register dependencies
