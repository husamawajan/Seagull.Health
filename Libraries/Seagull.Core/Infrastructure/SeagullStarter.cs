//------------------------------------------------------------------------------
// The contents of this file are subject to the SeagullCommerce Public License Version 1.0 ("License"); you may not use this file except in compliance with the License.
// You may obtain a copy of the License at  http://www.SeagullCommerce.com/License.aspx. 
// 
// Software distributed under the License is distributed on an "AS IS" basis, WITHOUT WARRANTY OF ANY KIND, either express or implied. 
// See the License for the specific language governing rights and limitations under the License.
// 
// The Original Code is SeagullCommerce.
// The Initial Developer of the Original Code is SeagullSolutions.
// All Rights Reserved.
// 
...
using Seagull.Core.Tasks;

namespace Seagull.Core.Infrastructure
{
    [Obsolete("This work is performed in SeagullEngine", true)]
    public class SeagullStarter
    {
