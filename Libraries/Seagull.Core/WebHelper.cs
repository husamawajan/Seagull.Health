...
namespace Seagull.Core
{
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        protected virtual bool TryWriteGlobalAsax()
        {
            try
            {
                //When a new plugin is dropped in the Plugins folder and is installed into SeagullCommerce, 
                ...
                //The issue is described here: http://www.Seagullcommerce.com/boards/t/10969/Seagull-20-plugin.aspx?p=4#51318
        ...
        public virtual string ServerVariables(string name)
        {
            ...
            try
            {
                ...
                //as described here http://www.Seagullcommerce.com/boards/t/21356/multi-store-roadmap-lets-discuss-update-done.aspx?p=6#90196
        ...
        public virtual void RestartAppDomain(bool makeRedirect = false, string redirectUrl = "")
        {
            ...
            else
            {
                ...
                if (!success)
                {
                    throw new SeagullException("SeagullCommerce needs to be restarted due to a configuration change, but was unable to do so." + Environment.NewLine +
        ...
        public virtual bool IsPostBeingDone
        {
            get
            {
                if (_httpContext.Items["Seagull.IsPOSTBeingDone"] == null)
                    return false;
                return Convert.ToBoolean(_httpContext.Items["Seagull.IsPOSTBeingDone"]);
            }
            set
            {
                _httpContext.Items["Seagull.IsPOSTBeingDone"] = value;
            }
        }
