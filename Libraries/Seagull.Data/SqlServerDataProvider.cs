...
using Seagull.Data.Initializers;
...
namespace Seagull.Data
{
    public class SqlServerDataProvider : IDataProvider
    {
        ...
        {
            //pass some table names to ensure that we have SeagullCommerce 2.X installed
            ...
            var initializer = new CreateTablesIfNotExist<SeagullObjectContext>(tablesToValidate, customCommands.ToArray());
