...
namespace Seagull.Services.Configuration
{
    /// <summary>
    /// Setting manager
    /// </summary>
    public partial class SettingService : ISettingService
    {
        ...
        /// Key for caching
        /// </summary>
        private const string SETTINGS_ALL_KEY = "Seagull.setting.all";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string SETTINGS_PATTERN_KEY = "Seagull.setting.";
