...
namespace Seagull.Services.Helpers
{
    ...
    public partial class UserAgentHelper : IUserAgentHelper
    {
        ...
        public UserAgentHelper(SeagullConfig config, HttpContextBase httpContext)
        {
            this._config = config;
        ...
        public virtual bool IsSearchEngine()
        {
            ...
            //more info: http://www.Seagullcommerce.com/boards/t/17711/unhandled-exception-request-is-not-available-in-this-context.aspx
            try
            {
