...
namespace Seagull.Services.Localization
{
    /// <summary>
    ...
    public partial class LocalizationService : ILocalizationService
    {
        ...
        /// {0} : language ID
        /// </remarks>
        private const string LOCALSTRINGRESOURCES_ALL_KEY = "Seagull.lsr.all-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// {1} : resource key
        /// </remarks>
        private const string LOCALSTRINGRESOURCES_BY_RESOURCENAME_KEY = "Seagull.lsr.{0}-{1}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string LOCALSTRINGRESOURCES_PATTERN_KEY = "Seagull.lsr.";
        ...
        public virtual string ExportResourcesToXml(Language language)
        {
            ...
            xmlWriter.WriteAttributeString("SupportedVersion", SeagullVersion.CurrentVersion);
