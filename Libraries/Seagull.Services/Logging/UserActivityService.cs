...
namespace Seagull.Services.Logging
{
    /// <summary>
    ...
    public class UserActivityService : IUserActivityService
    {
        ...
        /// Key for caching
        /// </summary>
        private const string ACTIVITYTYPE_ALL_KEY = "Seagull.activitytype.all";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string ACTIVITYTYPE_PATTERN_KEY = "Seagull.activitytype.";
