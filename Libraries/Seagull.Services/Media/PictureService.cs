...
namespace Seagull.Services.Media
{
    /// <summary>
    /// Picture service
    /// </summary>
    public partial class PictureService : IPictureService
    {
            ...
            ResizeType resizeType = ResizeType.LongestSide, bool ensureSizePositive = true)
        {
            ...
            //we invoke Math.Round to ensure that no white background is rendered - http://www.Seagullcommerce.com/boards/t/40616/image-resizing-bug.aspx
