...
namespace Seagull.Services.Tasks
{
    /// <summary>
    /// Task
    /// </summary>
    public partial class Task
    {
        ...
        public void Execute(bool throwException = false, bool dispose = true, bool ensureRunOnOneWebFarmInstance = true, bool cannotUpdateAudit = false)
        {
            //cannotUpdateAudit : you don't need to update tasks audit ;  
            ...
            try
            {
                ...
                if (ensureRunOnOneWebFarmInstance)
                {
                    ...
                    var SeagullConfig = EngineContext.Current.ContainerManager.Resolve<SeagullConfig>("", scope);
                    if (SeagullConfig.MultipleInstancesEnabled)
                    {
                        ...
                        {
                            if (SeagullConfig.RedisCachingEnabled)
                            {
                                //get expiration time
                ...
                if (!taskExecuted)
                {
                    ...
                    if (task != null)
                    {
                        if (scheduleTask != null)
                        {
                            if (cannotUpdateAudit)
                            { //you don't need to update tasks audit ;  
                            }
                            else
                            {
