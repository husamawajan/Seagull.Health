...
namespace Seagull.Services.Users
{
    ...
    public partial class UserAttributeService : IUserAttributeService
    {
        ...
        /// Key for caching
        /// </summary>
        private const string USERATTRIBUTES_ALL_KEY = "Seagull.userattribute.all";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : user attribute ID
        /// </remarks>
        private const string USERATTRIBUTES_BY_ID_KEY = "Seagull.userattribute.id-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : user attribute ID
        /// </remarks>
        private const string USERATTRIBUTEVALUES_ALL_KEY = "Seagull.userattributevalue.all-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        private const string USERATTRIBUTEVALUES_BY_ID_KEY = "Seagull.userattributevalue.id-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string USERATTRIBUTES_PATTERN_KEY = "Seagull.userattribute.";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string USERATTRIBUTEVALUES_PATTERN_KEY = "Seagull.userattributevalue.";
        #endregion
