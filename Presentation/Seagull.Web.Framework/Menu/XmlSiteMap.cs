...
namespace Seagull.Web.Framework.Menu
{
    public class XmlSiteMap
    {
        ...
        private static void PopulateNode(SiteMapNode siteMapNode, XmlNode xmlNode)
        {
            ...
            //title
            var SeagullResource = GetStringValueFromAttribute(xmlNode, "SeagullResource");
            var localizationService = EngineContext.Current.Resolve<ILocalizationService>();
            siteMapNode.Title = localizationService.GetResource(SeagullResource);
            ...
            if (!string.IsNullOrEmpty(controllerName) && !string.IsNullOrEmpty(actionName))
            {
                ...
                //apply admin area as described here - http://www.Seagullcommerce.com/boards/t/20478/broken-menus-in-admin-area-whilst-trying-to-make-a-plugin-admin-page.aspx
