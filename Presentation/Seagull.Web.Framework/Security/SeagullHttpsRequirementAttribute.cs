...
namespace Seagull.Web.Framework.Security
{
    ...
    public class SeagullHttpsRequirementAttribute : FilterAttribute, IAuthorizationFilter
    {
        public SeagullHttpsRequirementAttribute(SslRequirement sslRequirement)
        {
        ...
        public virtual void OnAuthorization(AuthorizationContext filterContext)
        {
            ...
            switch (this.SslRequirement)
            {
                ...
                case SslRequirement.NoMatter:
                    ...
                    break;
                default:
                    throw new SeagullException("Not supported SslProtected parameter");
            }
        }
