    ...
    public partial class AddressAttributeController : BaseAdminController
    {
        ...
        public virtual ActionResult Create(AddressAttributeModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _userActivityService.InsertActivity("AddNewAddressAttribute", _localizationService.GetResource("ActivityLog.AddNewAddressAttribute"), addressAttribute.Id);
        ...
        public virtual ActionResult Edit(AddressAttributeModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _userActivityService.InsertActivity("EditAddressAttribute", _localizationService.GetResource("ActivityLog.EditAddressAttribute"), addressAttribute.Id);
        ...
        public virtual ActionResult Delete(int id)
        {
            ...
            //activity log
            _userActivityService.InsertActivity("DeleteAddressAttribute", _localizationService.GetResource("ActivityLog.DeleteAddressAttribute"), addressAttribute.Id);
        ...
        public virtual ActionResult ValueCreatePopup(string btnId, string formId, AddressAttributeValueModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _userActivityService.InsertActivity("AddNewAddressAttributeValue", _localizationService.GetResource("ActivityLog.AddNewAddressAttributeValue"), cav.Id);
        ...
        public virtual ActionResult ValueEditPopup(string btnId, string formId, AddressAttributeValueModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _userActivityService.InsertActivity("EditAddressAttributeValue", _localizationService.GetResource("ActivityLog.EditAddressAttributeValue"), cav.Id);
        ...
        public virtual ActionResult ValueDelete(int id)
        {
            ...
            //activity log
            _userActivityService.InsertActivity("DeleteAddressAttributeValue", _localizationService.GetResource("ActivityLog.DeleteAddressAttributeValue"), cav.Id);
