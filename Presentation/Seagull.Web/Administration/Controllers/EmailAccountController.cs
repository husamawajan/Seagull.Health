	...
	public partial class EmailAccountController : BaseAdminController
	{
		...
		public virtual ActionResult Create(EmailAccountModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _userActivityService.InsertActivity("AddNewEmailAccount", _localizationService.GetResource("ActivityLog.AddNewEmailAccount"), emailAccount.Id);
        ...
        public virtual ActionResult Edit(EmailAccountModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _userActivityService.InsertActivity("EditEmailAccount", _localizationService.GetResource("ActivityLog.EditEmailAccount"), emailAccount.Id);
        ...
        public virtual ActionResult SendTestEmail(EmailAccountModel model)
        {
            ...
            try
            {
                if (String.IsNullOrWhiteSpace(model.SendTestEmailTo))
                    throw new SeagullException("Enter test email address");
	    ...
	    public virtual ActionResult Delete(int id)
	    {
	        ...
	        try
	        {
                ...
                //activity log
                _userActivityService.InsertActivity("DeleteEmailAccount", _localizationService.GetResource("ActivityLog.DeleteEmailAccount"), emailAccount.Id);
