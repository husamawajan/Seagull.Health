    ...
    public partial class MessageTemplateController : BaseAdminController
    {
        ...
        public virtual ActionResult Edit(MessageTemplateModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _userActivityService.InsertActivity("EditMessageTemplate", _localizationService.GetResource("ActivityLog.EditMessageTemplate"), messageTemplate.Id);
        ...
        public virtual ActionResult Delete(int id)
        {
            ...
            //activity log
            _userActivityService.InsertActivity("DeleteMessageTemplate", _localizationService.GetResource("ActivityLog.DeleteMessageTemplate"), messageTemplate.Id);
