    ...
    public partial class TopicController : BaseAdminController
    {
        ...
        protected virtual void PrepareAclModel(TopicModel model, Topic topic, bool excludeProperties)
        {
            ...
            if (!excludeProperties && topic != null)
                model.SelectedUserRoleIds = _aclService.GetUserRoleIdsWithAccess(topic).ToList();
        ...
        public virtual ActionResult Create(TopicModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _userActivityService.InsertActivity("AddNewTopic", _localizationService.GetResource("ActivityLog.AddNewTopic"), topic.Title ?? topic.SystemName);
        ...
        public virtual ActionResult Edit(TopicModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _userActivityService.InsertActivity("EditTopic", _localizationService.GetResource("ActivityLog.EditTopic"), topic.Title ?? topic.SystemName);
        ...
        public virtual ActionResult Delete(int id)
        {
            ...
            //activity log
            _userActivityService.InsertActivity("DeleteTopic", _localizationService.GetResource("ActivityLog.DeleteTopic"), topic.Title ?? topic.SystemName);
