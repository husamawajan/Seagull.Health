...
namespace Seagull.Web.Controllers
{
    public partial class CommonController : BasePublicController
    {
        ...
        //Language Public
        [ChildActionOnly]
        public virtual ActionResult LanguageSelectorPublic()
        {
            var model = _commonModelFactory.PrepareLanguageSelectorModel();
        ...
        public virtual ActionResult EuCookieLaw()
        {
            ...
            if (TempData["Seagull.IgnoreEuCookieLawWarning"] != null && Convert.ToBoolean(TempData["Seagull.IgnoreEuCookieLawWarning"]))
                return Content("");
