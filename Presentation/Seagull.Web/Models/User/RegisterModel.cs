...
namespace Seagull.Web.Models.User
{
    ...
    public partial class RegisterModel : BaseSeagullModel
    {
        ...
        [SeagullResourceDisplayName("Account.Fields.ConfirmEmail")]
        [AllowHtml]
        ...
        [NoTrim]
        [SeagullResourceDisplayName("Account.Fields.Password")]
        [AllowHtml]
        public string Password { get; set; }

        [DataType(DataType.Password)]
        [NoTrim]
        [SeagullResourceDisplayName("Account.Fields.ConfirmPassword")]
        [AllowHtml]
