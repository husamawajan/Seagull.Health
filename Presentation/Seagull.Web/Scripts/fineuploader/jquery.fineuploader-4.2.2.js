...
(function(){
    ...
    qq.basePrivateApi = {
        ...
        _generateExtraButtonSpecs: function() {
            ...
            qq.each(this._options.extraButtons, function(idx, extraButtoSeagulltionEntry) {
                var multiple = extraButtoSeagulltionEntry.multiple,
                    validation = qq.extend({}, self._options.validation, true),
                    extraButtonSpec = qq.extend({}, extraButtoSeagulltionEntry);
                ...
                if (extraButtonSpec.validation) {
                    qq.extend(validation, extraButtoSeagulltionEntry.validation, true);
                }
...
(function($) {
    "use strict";
    var $el,
        plugiSeagulltions = ["uploaderType", "endpointType"];
    ...
    function getNewUploaderInstance(params) {
        var uploaderType = plugiSeagulltion("uploaderType"),
            namespace = plugiSeagulltion("endpointType");
    ...
    function plugiSeagulltion(option, optionVal) {
    ...
    function transformVariables(source, dest) {
        ...
        $.each(source, function(prop, val) {
            if ($.inArray(prop, plugiSeagulltions) >= 0) {
                plugiSeagulltion(prop, val);
            }
